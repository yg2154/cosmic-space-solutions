...
const Index = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const GOOGLE_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbysowBaLsvWG4f3AFeusg9A9wp4Vh2cxMRgcqc9WbhkRVr6ZhFlM_JAfwilvpzkF1e7/exec';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Expert Vastu consultancy services for homes, offices, factories, hospitals, hotels, plots and shops. Email, on-site and walk-in consultations." />
        <link rel="canonical" href={canonical || "/"} />
        <meta property="og:title" content="Vaastu Acceleron | Expert Vastu Consultancy Services" />
        <meta property="og:description" content="Expert Vastu consultancy services providing holistic guidance for residences and businesses. Email, on-site and walk-in consultations." />
      ...
      <main id="top">
        <section className="container mx-auto px-4 py-16 md:py-24">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold leading-tight">Vaastu Acceleron — Expert Vastu Consultancy Services</h1>
